...
word_search_list = [  'availabilitystatus', 'availab', 'furnished', 'kitchen',"bedroom" ,"currency"]

semantic_search_list = [ 'name', 'shortname','location', 'bankaddress', 'corporatebankaddress',  'description', 'view',  
                        'bankname', 'bankbranch', 'operatorname', 'escrowaccountname', 'corporateaccountname', 'corporatebankname', 'corporatebankbranch', 'email']

numaric_search_list = ['id', 'phone', 'registrationnumber', 'developerid', 'buildingid', 'accountnumber', 'adminFee',
                        'corporateAaccountnumber', 'corporateibannumber', 'ibannumber', 'parking', 'projectid',
                        'paymenttermid', 'number', 'unitclusterid', 'baths', 'floor', 'plotnumber', 
                        'area', 'price', 'pricepersqft' ]


id_col_list = { "developers": ["id"],

...
# Config
# -----------------------
API_BASE = os.getenv("AGENT_API_BASE", "http://localhost:8001")  # FastAPI base URL
CHAT_ENDPOINT = f"{API_BASE}/chat"
RESET_ENDPOINT = f"{API_BASE}/reset"
HEALTH_ENDPOINT = f"{API_BASE}/health"

st.set_page_config(page_title="Agent1 Chat", page_icon="🤖", layout="centered")
...
# Header
# -----------------------
st.title("🤖 Agent1 Chat - Buildings")
